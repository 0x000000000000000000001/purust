...
with open('purust/src/Purust/CodeGen.purs', 'r') as f:
    content = f.read()
...
# Because in codegenModule, the variable is modNameStr, not currentMod
...
with open('purust/src/Purust/CodeGen.purs', 'w') as f:
    f.write(content)
