...
var codegenExpr_ = (currentMod) => (allZeroArity) => (allMacroBindings) => (mbLoop) => (aritiesMap) => (globalClassFields) => (bound) => (alive) => (inEffectBlock) => (v) => {
    ...
    if (inner.tag === "Lit" && inner._1.tag === "LitRecord") {
      ...
      if (v1.tag === "ADT" && v1._2.length >= 2) {
        ...
        return (modName === currentMod ? "crate::Value::Class(std::rc::Rc::new(crate::Dict_" + className + " { " : "crate::Value::Class(std::rc::Rc::new(Purs_" + modName + "::Dict_" + className + " { ") + joinWith(", ")(mapWithIndexArray((i) => (v2) => {
          ...
          const v3 = lookup5(modName + "_" + className)(globalClassFields);
          const expectedTy = (() => {
            if (v3.tag === "Just") {
  ...
  if (v.tag === "Accessor") {
    if (v._2.tag === "GetProp") {
      ...
      const v2 = unwrapType(inferTypeExpr(currentMod)(aritiesMap)(bound)(v._1));
      if (v2.tag === "ADT" && v2._2.length >= 2) {
        const modName = joinWith("_")((() => {
          const $0 = v2._2.length - 1 | 0;
          if ($0 < 1) {
            return [];
          }
          return sliceImpl(0, $0, v2._2);
        })());
        const className = sanitizeIdent((() => {
          const $0 = v2._2.length - 1 | 0;
          if ($0 >= 0 && $0 < v2._2.length) {
            return v2._2[$0];
          }
          return "Unknown";
        })());
        return boxUnbox(inferTypeExpr(currentMod)(aritiesMap)(bound)(v))((() => {
          const v3 = lookup5(modName + "_" + className)(globalClassFields);
          if (v3.tag === "Just") {
            const v4 = find((v5) => v5._1 === sanitizeIdent(v._2._1))(v3._1);
            if (v4.tag === "Just") {
              return v4._1._2;
            }
            if (v4.tag === "Nothing") {
          ...
          fail();
        })())(baseStr + ".unwrap_class::<" + (modName === currentMod ? "crate::Dict_" + className : "Purs_" + modName + "::Dict_" + className) + ">()." + sanitizeIdent(v._2._1) + ".clone()");
      }
      return boxUnbox(inferTypeExpr(currentMod)(aritiesMap)(bound)(v))(Any)(baseStr + ".unwrap_record()." + sanitizeIdent(v._2._1) + ".clone().unwrap()");
    }
  ...
  if (v.tag === "Var") {
    ...
    if (v2.tag === "Nothing") {
      ...
      const v3 = lookup5(key)(aritiesMap);
    ...
    return "{\n    " + joinWith("\n    ")(arrayMap((v1) => "let mut " + sanitizeIdent(v1._1) + " = crate::Value::Record(perceus_ptr::PerceusPtr::new(Record_a { ..Default::default() }));")($0)) + "\n    " + joinWith("\n    ")(mapWithIndexArray((i) => (v1) => {
      ...
      if (member2(sanitizeIdent(v1._1))(freeVariables(v1._2)) && (() => {
        ...
        const capturedArr = filterImpl(
          ...
          fromFoldableImpl(
            foldableSet.foldr,
            unsafeDifference(ordString.compare, freeVariables(v1._2), fromFoldable8(dedupedParams))
          )
        );
