...
- [ ] Réutiliser les cellules supplémentaires des rotations : isoler d'abord une rotation avec un enfant unique, puis partagé ou conservé dans une ancienne version. Transférer sa cellule vers l'une des constructions imbriquées, contrôler les allocations et la persistance, puis étendre aux trois autres rotations avant de remesurer la suite complète.
