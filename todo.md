...
- [ ] Isoler les allocations restantes lors d'une insertion dans l'arbre vide : compter séparément les constructeurs sans champ et les nœuds à données, puis tester le partage d'un constructeur vide natif avant toute généralisation. Vérifier persistance et références faibles, puis remesurer RBTree et la suite complète.
