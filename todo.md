...
La dernière [mesure appariée](../../altbak.pub-purust/scratch/rust-record-root-move-20260909/REPORT.md), après déplacement de la racine des records au dernier usage, donne **Records 0,938 → 0,837 ms (−10,8 %)** sur dix paires, réparties en deux séries. Le total **19,112 → 19,077 ms** ne démontre pas de gain global au regard de la dispersion. Les **21 tests de génération, 13 tests TAST et 14 résultats du runner** passent. La [fusion de Church](../../altbak.pub-purust/scratch/rust-function-fusion-20260909/REPORT.md) donnait **1,439 → 0,164 ms** sur ce cas ; la [recoloration](../../altbak.pub-purust/scratch/rust-recolor-field-20260909/REPORT.md), **RBTree 18,237 → 17,644 ms**. Chaque expérience conserve sa propre baseline. Le README normal relu pour la dernière étape affiche désormais **19,95 ms au total**, dont **18,449 ms RBTree**, **0,969 ms Records** et **0,173 ms Church** ; le tableau ci-dessus reste le relevé historique initial du plan.
...
- [ ] **Prochain bébé Records : réutiliser un niveau enfant.** Les deux niveaux intérieurs expliquent encore **20 000 copies** pour 10 000 itérations. Le [prototype d'audit](../../altbak.pub-purust/scratch/rust-records-audit-20260909/REPORT.md) réutilisant les trois niveaux mesurait 0,360 ms et 3 allocations ; ce résultat n'est pas intégré et ne prédit pas le gain de la prochaine étape. Commencer par un enfant, prouver l'accès exclusif au chemin et la conservation des anciennes versions, puis compter et mesurer avant de généraliser. Les layouts unboxés B21/B23 constituent une piste distincte.
