...
- [ ] Réutiliser les cellules du chemin et des rotations : commencer par un cas minimal où une fonction reconstruit un nœud pour son appelant. Établir comment préserver la cellule du parent à travers l'appel à `balance`, avec une entrée unique puis partagée, avant de généraliser aux rotations et de remesurer.
