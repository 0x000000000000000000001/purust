...
codegenExpr currentMod allZeroArity allMacroBindings mbLoop bound alive e = case extractVarType e of
  ...
  Nothing -> codegenExprInner currentMod allZeroArity allMacroBindings mbLoop bound alive e

codegenExprInner :: String -> Set.Set String -> Set.Set String -> Maybe { name :: String, params :: Array String } -> Map.Map String ExprType -> Set.Set String -> NeutralExpr -> String
codegenExprInner currentMod allZeroArity allMacroBindings mbLoop bound alive (NeutralExpr expr) = case expr of`;
